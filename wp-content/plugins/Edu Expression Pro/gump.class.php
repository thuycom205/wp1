...
class GUMP
{
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_min_age':
                    ...
                    break;
		case 'validate_alphaNumericCustom':
                    $resp[$field] = "The $field field containt invalid character";
                    break;
                default:
    ...
    */
    ...
    /* Determine alphaNumericCustom*/
      protected function validate_alphaNumericCustom($field, $input, $param = null)
    {
        if (!isset($input[$field]) || empty($input[$field])) {
            return;
        }
