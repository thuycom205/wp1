...
<head lang="en">
    ...
    <script id="editable">
        ...
        function init() {
            ...
            var textt = new createjs.Text("<?php echo $question_ana[0] ?>", "bold 24px Arial", "#0000FF");
            textt.x = 200;
            textt.y = 600;
            ...
            var button<?php echo $key?> = new Button("<?php echo $enAns ?>", "#F00");
             console.log(<?php echo$answer['correct'] ?>);
            button<?php echo $key?>.name = "button";
            button<?php echo $key?>.x = 70 + <?php echo $key *90?>;
            button<?php echo $key?>.y = 90;
            button<?php echo $key?>.dung = <?php echo $answer['correct'] ?>;
